...
var AppTree = (function ($) {
    ...
    var config = {
        ...
        url: _PORTALROOT_GLOBAL + '/TreeSourse/DoAction', //异步取树url地址
    ...
    var ResetConfig = function () {
        ...
        config.url = '/Portal/TreeSourse/DoAction';
    ...
    var init = function (setting) {
        ...
        if (config.root.appCode != null && config.root.appCode != "") {
            ...
            $.ajax({
                type: "POST",
                url: "/Portal/TreeSourse/DoAction",
                data: $.extend({
    ...
    var searchTree = function (searchKey) {
        var zsetting = {
            async: {
                enable: true,
                url: config.url,
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data != null) {
                    ...
                    if (config.displayType == DisplayType.Fixed) {
                        that.fixedPresent($("#sheet"), zsetting, znodes);
                    } else {
                        that.popUpPresent($("#sheet"), zsetting, znodes);
                    }
