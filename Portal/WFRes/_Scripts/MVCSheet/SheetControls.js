SheetControls = {
    ...
    SheetCheckboxList: {
        DesignProperties: [
            ...
            { Name: "VaildationRule", Description: "获取或设置控件的验证规则，为True时必填!", DefaultValue: "", ValueRange: null, RichProperty: true }
        ],
        DesignEvents: [
    ...
    SheetComment: {
        DesignProperties: [
            ...
            { Name: "DisplayHead", Description: "获取或设置是否显示用户头像(不适用移动端)", DefaultValue: true, ValueRange: [true, false] },
            { Name: "DisplayBorder", Description: "获取或设置历史意见是否显示边框(不适用移动端)", DefaultValue: true, ValueRange: [true, false] },
            ...
            { Name: "LastestCommentOnly", Description: "获取或设置是否显示最后一条意见(不适用移动端)", DefaultValue: false, ValueRange: [true, false] },
            { Name: "NullCommentTitleVisible", Description: "获取或设置当意见为空时是否显示意见标题(不适用移动端)", DefaultValue: true, ValueRange: [true, false] },
            { Name: "OUNameVisible", Description: "获取或设置是否显示OU名称", DefaultValue: false, ValueRange: [true, false] },
            { Name: "ActivityNameVisible", Description: "获取或设置是否显示活动节点名称(不适用移动端)", DefaultValue: true, ValueRange: [true, false] },
            { Name: "DateNewLine", Description: "获取或设置签名和日期是否换行(不适用移动端)", DefaultValue: false, ValueRange: [true, false] },
            { Name: "HasAttachment", Description: "是否允许上传附件", DefaultValue: false, ValueRange: [true, false] },
            { Name: "AllowBatchDownload", Text: "批量下载", Description: "获取或设置是否允许批量下载", DefaultValue: true, ValueRange: [true, false] },
            { Name: "FileExtensions", Text: "支持扩展名", Description: "获取或设置附件上传的文件名格式,示例:.jpg,.gif", DefaultValue: "", ValueRange: null },
            { Name: "MaxUploadSize", Text: "最大上传大小", Description: "获取或设置限制文件上传的大小(MB)，默认为 10MB", DefaultValue: 10, ValueRange: null }
        ]
    ...
    SheetGridView: {
        DesignProperties: [
           ...
           { Name: "DisplayText", Description: "获取或设置开窗查询文本", DefaultValue: "批量录入数据", ValueRange: null },
    ...
    SheetTextBox: {
        DesignProperties: [
            ...
            { Name: "RegularInvalidText", Description: "获取或设置验证失败时显示的文本", DefaultValue: "", ValueRange: null, Popup: "SheetTextBoxRegular", Height: 450, Width: 540 },
            { Name: "VaildationRule", Description: "获取或设置控件的验证表达式，为True时必填!", DefaultValue: "", ValueRange: null, RichProperty: true },
            { Name: "PopupWindow", Description: "获取或设置是否支持开窗查询", DefaultValue: "None", ValueRange: ["None", "PopupWindow", "Dropdown"] },
            { Name: "DisplayText", Description: "获取或设置开窗查询文本", DefaultValue: "选择", ValueRange: null },
            { Name: "PopupHeight", Description: "获取或设置开窗查询高度", DefaultValue: "400px", ValueRange: null },
    ...
    SheetTime: {
        ...
        DesignProperties: [
            ...
            { Name: "MinValue", Description: "获取或设置日期控件显示的最小值", DefaultValue: "2010-01-01", ValueRange: null },
            { Name: "MaxValue", Description: "获取或设置日期控件显示的最大值", DefaultValue: "2050-12-31", ValueRange: null },
    ...
    SheetUser: {
        DesignProperties: [
             ...
             { Name: "FrequentUserVisible", Description: "获取或设置是否显示【最近联系人】", DefaultValue: false, ValueRange: [true, false] },
             { Name: "DepartmentUserVisible", Description: "获取或设置是否显示【我的部门】", DefaultValue: false, ValueRange: [true, false] },
...
var SheetLanguages = {
    ...
    zh_cn: {
        ...
        TakePhotos: '拍照',
        FileSelect: '文件选择',
        AttachmentAction: '附件操作',
        NotSupportExtension: '不支持的附件格式,请在PC端查看',
        DownloadTip: "下载文件会导致未保存数据丢失,确认下载？",
        SuccessSave: "保存成功",
        More: "更多",
        Comfirm: '确定',
        State: '流程状态',
        ...
        InputYourUrgenContent: '请输入催办内容',
        PleaseInput: '请输入',
        PleaseSelect: '请选择',
        FreComments: '常用意见',
        AttachmentComments: '附件',
        ...
        EnterIntegerLength: "请输入一个不超过10位的整数",
        EnterIntegerLengths: "请输入一个不超过19位的长整数",
        EnterNumber: "请输入一个有效的数值",
        EnterNumberLength: "请输入一个15位有效数字的数值",
        Day: "天",
        Hour: "小时",
        Minute: "分钟",
        Second: "秒",
        ...
        ConfirmDo: "确定执行",
        Operation: "操作",
        SheetTimeDateRange: "可选日期范围",
        CirculateError1: "不能传阅给发起人！",
        CirculateError2: "不能传阅给当前流程的参与者!",
        CirculateError3: "不能传阅传阅过的用户",
        CirculateError4: "不能传阅自己！",
        OverCirculateUserLimit: "超过最大限制数：200，请联系管理员操作！",
        AssistError1: "不能协办请求您协办的用户！",
        AssistError2: "不能协办自己！",
        AssistError3: "{0} 已被{1},不能再次{1}",
        AssistError4: "其余{0}成功!",
        AssistError5: "不能协办给发起人！",
        AssistError6: "不能协办给参与者！",
        ConsultantError1: "不能征询征询过的用户",
        ConsultantError2: "不能征询请求您征询的用户！",
        ConsultantError3: "不能征询自己！",
        ConsultantError4: "不能征询给发起人！",
        ConsultantError5: "不能征询参与者!",
        ClickImageDelete: "(点击图像删除)",
        AppendixPreview: "附件预览",
        MistakeInput: "您有{0}项内容未填写",
        ErrorInput: "您有{0}项内容填写错误",
        ValidInput: "您有{0}项内容未填写,有{1}项内容填写错误",
        Submited:"请勿重复提交",
        //表单基本信息中英文特殊处理
        BasicInfo: {
            divFullName: '发起人',
        ...
        ISOVideoUploadWarn: "IOS系统暂不支持上传视频附件",
        Query: "查询",
        AssociatedSheet: "关联查询",
        noComment: "您没有可选常用意见，请在后台设置",
        noSignatrue: "您没有可选签章，请在后台设置",
        GridImporting: "子表导入中..."
    },
    en_us: {
        Success: "Success",
        ...
        TakePhotos: 'Camera',
        FileSelect: 'Files',
        AttachmentAction: 'Atatchment',
        NotSupportExtension: 'Not support extension,check it on PC please .',
        DownloadTip: "Downloading files can cause unsaved data to be lost,download it?",
        ...
        InputYourUrgenContent: 'Please enter your Consult content',
        PleaseInput: 'Please input',
        PleaseSelect: 'Please select',
        FreComments: 'My frequentely used comments',
        AttachmentComments: 'Attachment',
        ApprovalAttachment: 'Attachment for Approval',
        ...
        UrgenContent: "Urgen Content",
        UrgenTime: "Urgen Time",
        UrgenList: "Urgen History",
        Urgen: 'Urgen',
        Forward: 'Forward',
        Assist: 'Assist',
        _Assist: 'Assist',
        ...
        EnterNumberLength: "Please enter a no more than 15 valid number",
        EnterIntegerLength: "Please no more than 9",
        EnterIntegerLengths: "Please no more than 19",
        Day: "Day",
        Hour: "Hour",
        Minute: "Minute",
        Second: "Second",
        ...
        Operation: "",
        SheetTimeDateRange: "Date range",
        CirculateError1: "Circulate to originator is not allowed !",
        CirculateError2: "Circulate to current workflow participants is not allowed !",
        CirculateError3: "Can not circulate the user who had been circulate !",
        CirculateError4: "Can not circulate with yourself !",
        OverCirculateUserLimit: "Limited :200，connect adminstrator please！",
        AssistError1: "Can not assist the user who assist you !",
        AssistError2: "Can not assist with yourself !",
        AssistError3: "{0} already {1},Cannot continue {1}",
        AssistError4: "The rest {0} success !",
        AssistError5: "Can not assist originator !",
        AssistError6: "Can not assist participants!",
        ConsultantError1: "Can not consultant the user who had been consultanted  !",
        ConsultantError2: "Can not consultant the user who consultant you !",
        ConsultantError3: "Can not consultant yourself !",
        ConsultantError4: "Can not consultant originator !",
        ConsultantError5: "Can not consultant participants !",
        ClickImageDelete: "(Click Image Delete)",
        AppendixPreview: "Appendix Preview",
        MistakeInput: "{0} items unfilled",
        ErrorInput: "{0} fill in the error",
        ValidInput: "{0} items unfilled,{1} fill in the error",
        Submited: "do not resubmit",
        //表单基本信息中英文特殊处理
        BasicInfo: {
        ...
        States: {
            ...
            Forward: 'Forward to',
            Consult: 'Consult to',
            SystomAssist: '[Systom Assist]',
            SystomForward: '[Systom Forward]',
            SystomConsult: '[Systom Consult]',
        },
        SheetUser: {
            isShow: false,
        ...
        ISOVideoUploadWarn: "Can't uploading video in IOS system temporarily",
        Query: "Query",
        AssociatedSheet: "Associated Sheet",
        noComment: "You have not set the signatrue,please set it in Workflow Center!",
        noSignatrue: "You have not set frequently used comments,please set it in Workflow Center!",
