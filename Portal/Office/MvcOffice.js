var MvcOffice = function (wordObject, sheetOfficeInfo) {
...
MvcOffice.prototype = {
    ...
    saveDocument: function (title) {
        ...
        (
            //this.sheetOfficeInfo.rootURI
            this.sheetOfficeInfo.PortalRoot + "/Office/SaveOfficeAttachment",  // 保存的文件地址
    ...
    saveAsPDF: function (download) {
        ...
        if (this.fileOpen && this.TANGER_OCX_OBJ.IsPDFCreatorInstalled()) {
            ...
            var result = this.TANGER_OCX_OBJ.PublishAsPDFToURL(this.sheetOfficeInfo.PortalRoot + "/OfficeService/SaveOfficeAttachment", //提交到的url地址
