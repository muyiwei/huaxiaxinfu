    ...
    .config(function ($stateProvider, $urlRouterProvider, $ionicConfigProvider, $sceDelegateProvider) {
        ...
        $stateProvider
            .state('form', {
                url: '/form',
                abstract: true,
                templateUrl: function () { return _PORTALROOT_GLOBAL + '/Mobile/form/templates/empty.html' },
                controller: "mainCtrl",
                params: {
                    dataField: "",
                    loadUrl: "",
            ...
            .state('form.detail', {
                ...
                views: {
                    'form-detail': {
                        templateUrl: function () { return _PORTALROOT_GLOBAL + '/Mobile/form/templates/formDetail.html' },
                        controller: 'formSheetCtrl'
                    }
                }
            })
            //objectid绑定查询列表已经选择的id
            .state('form.sheetquery', {
                url: '/sheetquery/:datafield/:rownum/:objectid',
                views: {
                    'form-detail': {
                        templateUrl: function () { return _PORTALROOT_GLOBAL + '/Mobile/form/templates/sheetQuery.html' },
            ...
            .state('form.sheetuser', {
                ...
                views: {
                    'form-detail': {
                        templateUrl: function () { return _PORTALROOT_GLOBAL + '/Mobile/form/templates/sheetUser.html' },
        ...
        //传阅、征询、转发路由
         .state('form.fetchuser', {
             ...
             views: {
                 'form-detail': {
                     templateUrl: function () { return _PORTALROOT_GLOBAL + '/Mobile/form/templates/FetchUser.html' },
        ...
        .state('form.instancestate', {
            ...
            views: {
                'form-detail': {
                    templateUrl: function () { return _PORTALROOT_GLOBAL + '/Mobile/form/templates/instanceState.html' },
        ...
        .state('form.downLoadFile', {
            ...
            views: {
                'form-detail': {
                    templateUrl: function () { return _PORTALROOT_GLOBAL + '/Mobile/form/templates/downLoadFile.html' },
