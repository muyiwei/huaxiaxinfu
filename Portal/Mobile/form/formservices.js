...
.service("fcommonJS", function ($ionicModal, $http, $ionicLoading, $cordovaToast,
    ...
    this.loadingShow = function (msg) {
        ...
        if (lang == 'en_us') {
            if (!msg) msg = "<span class=\"lodingspan\"><ion-spinner icon=\"ios\" class=\"centerscreen spinner-light \"></ion-spinner><span>Data loading…</span></span>";
        } else if (lang == 'zh_cn') {
            if (!msg) msg = "<span class=\"lodingspan\"><ion-spinner icon=\"ios\" class=\"centerscreen spinner-light \"></ion-spinner><span>数据加载中…</span></span>";
        }
       $ionicLoading.show({
            template: msg,
            duration: 6 * 1000
