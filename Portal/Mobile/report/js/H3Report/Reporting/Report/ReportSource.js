...
ReportSourceManager.prototype = {
    ...
    View_ShowSchemaSelecter: function (source) {
        ...
        modal = $.IModal({
            Title: '定义数据源', Width: width, Height: height, OnShowCallback: shownCallback, OnHiddenCallback: null, Content: that.SchemaSelectPanel, ToolButtons: actions, ShowHeader: true
        });
    },
    //初始化选择的数据源
