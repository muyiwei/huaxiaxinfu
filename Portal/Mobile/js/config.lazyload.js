...
angular.module('starter')
  ...
  .constant('JQ_CONFIG', {
      ...
      //],                        
      LoadReportPage: [
                          'report/css/H3Report/bootstrap-select.min.css',
                          'report/css/bootstrapMobile.css',
                          'report/css/H3Report/bootstrap-datetimepicker/bootstrap-datetimepicker.css',
                           'report/css/H3Report/dataTables-bootstrap/dataTables.bootstrapMobile.min.css',
                           'report/css/H3Report/autocomplete/jquery.autocomplete.css',
                           'report/css/H3Report/SheetUser.css',
                           'report/css/H3Report/PageTurnMobile.css',
                           'report/css/H3Report/H3-Icon-Tool/style.css',
                           'report/css/H3Report/ChartBase.css',
                           'report/css/H3Report/DropDownList.css',
                          'report/css/H3Report/Reporting/ReportMobileView.css',
                          'report/css/H3Report/jquery.gritter.css',
                          'report/js/H3Report/jquery.gritter.min.js',
                          'report/js/H3Report/H3.plugins.system.js',
                          'report/js/H3Report/bootstraptable/bootstrap-datetimepicker.js',
                          'report/js/H3Report/bootstraptable/jquery.nicescroll.min.js',
                          'report/js/H3Report/bootstraptable/bootstrap-datetimepicker.zh-CN.js',
                          'report/js/H3Report/bootstraptable/bootstrap-table.js',
                          'report/js/H3Report/bootstraptable/bootstrap-table-zh-CN.js',
                          'report/lib/jquery.dataTables.min.js',
                          'report/js/H3Report/echart/echarts.js',
                          'report/js/H3Report/Reporting/Report/ReportBase.js',
                          'report/js/H3Report/Reporting/ReportViewManagerMobile.js',
                          'report/js/H3Report/H3Chart/ChartBase.js',
                          'report/js/H3Report/H3Chart/excanvas.min.js',
                          'report/js/H3Report/H3Chart/Chart.js',
                          'report/js/H3Report/html2canvas.js',
      ],
